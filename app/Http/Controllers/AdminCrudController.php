...
class AdminCrudController extends Controller
{
    public function index()
    {
        ...
        ->select('tbfilmes.id_filme', 'tbfilmes.titulo_filme', 'tbfilmes.id_filme', 'tbfilmes.genero_filme', 'tbfilmes.disponiveis_filme', 'tbfilmes.valor_filme', 'tbfilmes.sinopse_filme', 'tbgeneros.nome_genero')
        ->get();
