    ...
    public function run(){
        $data = array(
            [
                ...
                'link_filme' => 'https://www.youtube.com/watch?v=tivv135aGbc',
                'genero_filme' => 1,
            ],
            [
                ...
                'valor_filme' => 30.00,
                'disponiveis_filme' => 5,
                'link_filme' => 'https://www.youtube.com/watch?v=7kSuas6mRpk',
                'genero_filme' => 2,
            ],
            [
                ...
                'link_filme' => 'https://www.youtube.com/watch?v=UEcGnFH5V0E',
                'genero_filme' => 3,
            ],
            [
                ...
                'link_filme' => 'https://www.youtube.com/watch?v=kMyJWuvW_9k',
                'genero_filme' => 4,
            ],
            [
                ...
                'valor_filme' => 15.00,
                'disponiveis_filme' => 10,
                'link_filme' => 'https://www.youtube.com/watch?v=ZY47kcM1DlE',
                'genero_filme' => 5,
            ],
            ...
            [
                ...
                'valor_filme' => 30.00,
                'disponiveis_filme' => 6,
                'link_filme' => 'https://www.youtube.com/watch?v=eBKvlCf0B4g',
                'genero_filme' => 1,
            ],
        );
        foreach ($data as $d){
