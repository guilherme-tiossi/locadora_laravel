...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['class' => 'link-menu','href' => '/logout','onclick' => 'event.preventDefault();
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'link-menu','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('/logout'),'onclick' => 'event.preventDefault();
...
<?php endif; ?>
<?php /**PATH /home/tiossi/act311/locadora_laravel/resources/views/lista-filmes.blade.php ENDPATH**/ ?>